            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                            <input type="text" name="blog_title" placeholder="Title" class="form-control" required></div>
                            <div class="mb-3">
                                <label>Body/Description</label>
                                <textarea  required class="form-control" name="blog_body" rows="2" id="blog"></textarea>
                              </div>
                            <div class="mb-3">
                                <input type="file"name="blog_image" class="form-control" class="form-control" required>
                            </div>
                            <div class="mb-3">
    ...
    if(in_array($image_ext,$allow_type)){
        if($size<=2000000){
            ...
            if($query2){
                ...
                $_SESSION['msg']=$msg;
                header("location:http://localhost/blog/admin/add_blog.php");
            }
            else{
