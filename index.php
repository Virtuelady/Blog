            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
               ...
               <tbody>
                  <?php
                   ...
                   LEFT JOIN user ON blog.author_id=user.user_id WHERE user_id='$userID'  
                   ...
                   if($rows){
                     while($result=mysqli_fetch_assoc($query)){
                        ...
                        <tr>
                           ...
                           <td>
               <?php if (!empty($result['blog_image'])) { ?>
                  <img src="upload/<?= $result['blog_image'] ?>" alt="Blog Image" width="80" height="60" style="border-radius:5px;">
               <?php } else { ?>
                  No Image
               <?php } ?>
            </td>
