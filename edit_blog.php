                ...
                <div class="card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                            ...
                            required value="<?= $result['blog_title'] ?>
"></div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <input type="file"name="blog_image" class="form-control" class="form-control" >
    ...
    if(!empty($filename)){
        if(in_array($image_ext,$allow_type)){
            if($size<=2000000){
                ...
                $sql3="UPDATE blog SET blog_title='$title',blog_body='$body',blog_image='$filename',
                category='$category',author_id='$author_id' WHERE blog_id='$blogID'";
                ...
                $msg= ['image size sholud not be greater than 2mb','alert-danger'];
                $_SESSION['msg']=$msg;
                header("location:http://localhost/blog/admin/index.php");
            }
